About warctools-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/warctools-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/internetarchive/warctools
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5066&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/warctools-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `warctools` can be installed with `conda`:
...
```
mamba install warctools
```

It is possible to list all of the versions of `warctools` available on your platform with `conda`:
...
```
mamba search warctools --channel conda-forge
```
...
mamba repoquery search warctools --channel conda-forge

# List packages depending on `warctools`:
mamba repoquery whoneeds warctools --channel conda-forge

# List dependencies of `warctools`:
mamba repoquery depends warctools --channel conda-forge
```
